...
namespace WhatisClass
{
    public class TwoGame
    {
        public static void Main()
        {
            ...
            //tiger_.NAME = "백 호랑이";
            //Console.WriteLine("{0}", tiger_.Test);

            //Console.WriteLine("원래 {0} 의 공격력 {1} ", robot_.NAME, robot_.ATTACKPOINT);
            //robot_.ATTACKPOINT = 100;
            //Console.WriteLine("변경된 {0} 의 공격력 {1} ", robot_.NAME, robot_.ATTACKPOINT);
    ...
    class CharactorInfo
    {
        ...
        //(public만) 외부에서 보여주거나 설정하거나 할때 간략하게 한줄 property 
        ...
        {   get { return this.AttakPoint; }
            set { this.AttakPoint = value; } }

        public int DEFENCEPOINT
        {   get { return this.DefencePoint; }
            set { this.DefencePoint = value; } }
